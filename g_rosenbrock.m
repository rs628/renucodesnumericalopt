...
function [g_r, r]= g_rosenbrock(g_x, x)
   g_tmp_x_00000= g_x(1);
   tmp_x_00000= x(1);
   g_tmp_rosenbrock_00000= adimat_g_pow_left(g_tmp_x_00000, tmp_x_00000, 2);
   tmp_rosenbrock_00000= tmp_x_00000^ 2;
   g_tmp_rosenbrock_00001= 10* g_tmp_rosenbrock_00000;
   tmp_rosenbrock_00001= 10* tmp_rosenbrock_00000;
   g_tmp_x_00001= g_x(2);
   tmp_x_00001= x(2);
   g_tmp_rosenbrock_00002= adimat_g_pow_left(g_tmp_x_00001, tmp_x_00001, 2);
   tmp_rosenbrock_00002= tmp_x_00001^ 2;
   g_r= g_tmp_rosenbrock_00001+ g_tmp_rosenbrock_00002;
   r= tmp_rosenbrock_00001+ tmp_rosenbrock_00002; 
